...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pacilButton = document.querySelector(`.division__btn[href="#${pacilFilter}"]`);
    ...
    const aboutUsButton = document.querySelector(`.division__btn[href="#${aboutUsFilter}"]`)

    if (aboutUsButton) {
        aboutUsButton.classList.add('active');
        filterBlocks(aboutUsFilter);
    }
